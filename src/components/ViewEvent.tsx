    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
                ...
                <div className="bg-white rounded-lg p-6 max-w-sm w-full">
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="flex gap-2 w-full">
                      ...
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText(`${window.location.origin}/upload-selfie/${eventId}`);
          ...
          <label className="cursor-pointer bg-primary text-white py-2 px-4 rounded-lg hover:bg-secondary transition-colors duration-200 flex items-center">
      ...
      <div className="space-y-8">
          {Object.entries(faceGroups).map(([groupId, groupImages]) => (
            <div key={groupId} className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-700">Face Group {groupId.split('_')[1]}</h3>
